...
#cgo !windows LDFLAGS: -L/usr/local/lib -L/usr/local/lib/opencv4/3rdparty -lopencv_highgui -lopencv_calib3d -lopencv_features2d -lopencv_flann -lopencv_photo -lopencv_videoio -lopencv_video -lopencv_imgcodecs -lopencv_imgproc -lopencv_core -lz -ljpeg
